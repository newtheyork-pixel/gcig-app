...
const KNOWN_FUNCTIONS = [
  ...
  { id: 'HALT', label: 'Trading Halts', summary: 'Live Nasdaq and NYSE halt tape with decoded reasons; held names flagged.' },
  { id: 'SI', label: 'Short Interest', summary: 'Bi-monthly shares short, change and days to cover from FINRA, plus the latest day\'s off-exchange short-volume share.' },
  { id: 'CORR', label: 'Correlation', summary: 'Pairwise correlation of the book\'s daily returns (3m/1y) plus each name\'s correlation to the rest of the book.' },
  { id: 'DVD', label: 'Dividend History', summary: 'Cash dividend history with ex/pay/record/declaration dates, yield and annualized rate; flags raises and cuts. Nasdaq-listed names only, the upstream declines NYSE symbols.' },
  ...
  { id: 'HOOT', label: 'Squawk Box', summary: 'The desk squawk box: who is on the terminal, the shared Trade Desk, and a direct line to any one person. Hold to talk. Also answers to SQUAWK and DESK.' },
  { id: 'SQUAWK', label: 'Squawk Box', summary: 'Alias for HOOT.' },
  { id: 'DESK', label: 'Squawk Box', summary: 'Alias for HOOT.' },
