...
enum Registry {
    static let all: [TerminalFunction] = [
        ...
        .init(id: "INBX", aliases: ["INBOX"], label: "Inbox",
              help: "Every reply that has come in, across every project, newest first. Who is owed an answer.",
              width: 900, height: 640, native: true),
        ...
        .init(id: "MEET", aliases: ["VC", "ZOOM"], label: "Meetings",
              help: "Video meetings on the club's own server: start one now, schedule one, copy the link or mail it to yourself.",
              width: 640, height: 520, native: true),
        .init(id: "CHK", aliases: ["CALL"], label: "Channel Check",
              help: "Ring stores from the desk: the queue, the disclosure to read, the outcome, and the transcript.",
              width: 1000, height: 700, native: true),
        .init(id: "FAC", aliases: ["PLANTS"], label: "Facilities",
              help: "Where a company's plants are: address, town and coordinates, from the EPA facility registry.",
              requires: "ticker", width: 1040, height: 620, native: true),
